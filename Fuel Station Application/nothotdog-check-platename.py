...
def find_car(imgname):
    ...
    if not resHasVehicle:
        ...
        if(numberPlate):
            ...
            if(content_json['status'] == 'not_found'):
                return json.dumps({"status": "substitute", "rego": "ZOY588", "vehicle": "2012 BLACK MAZDA SEDAN", "stolen": "", "registration": "Current - 04/02/2019"})
            else:
